...
##### 나라's 답변: 간단히 말하면 TCP는 연결형 서비스를 사용하기 때문에 신뢰성을 보장합니다. TCP의 연결 과정을 살펴본다면 쉽게 이해할 수 있는데요, 연결을 할 때 3wayHandshake, 해제할 때 4wayHandshake를 사용하기에 연결을 지속적으로 하여 상대방의 상태를 계속 체크하며 데이터를 보내기때문에 신뢰성을 보장한다고 말 할 수 있습니다.
...
### 나라's 답변: REST아키텍처의 조건을 따르는 API를 말합니다.
